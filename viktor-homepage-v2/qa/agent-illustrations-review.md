...
- Some illustration icons remain generic real-product glyphs (for example the dashboard glyph for Progress); this is a known non-blocking fidelity deviation requiring a separate semantic-icon refinement. No invented artwork or employee photos were added.
