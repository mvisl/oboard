(() => {
  ...
  function retrospective(){
    ...
    return product('<div class="ai-retro">'+summary+objectives+metrics+'</div>','Home')+
      ...
      '<aside class="ai-secondary ai-icon-evidence ai-carry-evidence">'+tile('ds-list','purple')+'<div><h5>EMEA dependencies</h5><span class="ai-carry-link">Carry to Q4 →</span></div></aside>';
  }
  function drafting(){
