(() => {
  ...
  function checkin(){
    const feed='<h4>Check-ins</h4><div class="ai-feed-day">2 days ago</div><article class="ai-feed-entry"><header>'+person('AL')+'<div>'+skeleton('80px')+'<small>2 days ago, 9:30 AM</small></div></header><div class="ai-feed-body"><div class="ai-feed-entity"><span class="ai-tile orange">KR</span>'+skeleton('148px')+'</div><div class="ai-feed-field"><b>Value</b>'+skeleton('28px')+'<span>→</span>'+skeleton('28px')+'</div><div class="ai-feed-field"><b>Progress</b><span>50%</span><span>→</span><strong>60%</strong></div><div class="ai-feed-field"><b>Status</b><span class="ai-feed-status">On Track</span></div></div><footer>Reply <span>React</span></footer></article><article class="ai-feed-entry ai-feed-older"><header>'+person('B')+'<div>'+skeleton('90px')+skeleton('48px',true)+'</div></header><div class="ai-feed-body">'+skeleton('85%')+skeleton('65%',true)+'</div></article>';
  ...
  function engagement(){
    const report='<h4>Performance report</h4><div class="ai-report-switches"><span>By group</span><b>People</b><b>By status</b><span>Progress</span></div><div class="ai-status-table"><div class="ai-status-table-head"><span>People</span><span>On Track</span><span>Behind</span><span>Avg.total</span></div>'+[['AL',72],['B',68],['M',74]].map(([initial,value])=>'<div class="ai-status-person"><div class="ai-status-person-name">'+person(initial)+'<div>'+skeleton('64px')+'<small>Objectives</small></div></div>'+skeleton('18px')+skeleton('18px')+'<span class="ai-status-average">'+value+'%</span></div>').join('')+'</div>';
